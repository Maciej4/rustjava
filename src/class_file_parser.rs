...
pub fn bytes_to_bytecode(code: Vec<u8>) -> Vec<Instruction> {
    ...
    while pc < code.len() as usize {
        instructions.push(match code[pc] {
            ...
            25 => Instruction::Load(u1(&code, &mut pc), PrimitiveType::Address),
            ...
            42 => Instruction::Load(0, PrimitiveType::Address),
            43 => Instruction::Load(1, PrimitiveType::Address),
            44 => Instruction::Load(2, PrimitiveType::Address),
            45 => Instruction::Load(3, PrimitiveType::Address),
            ...
            50 => Instruction::ALoad(PrimitiveType::Address),
            ...
            58 => Instruction::Store(u1(&code, &mut pc), PrimitiveType::Address),
            ...
            75 => Instruction::Store(0, PrimitiveType::Address),
            76 => Instruction::Store(1, PrimitiveType::Address),
            77 => Instruction::Store(2, PrimitiveType::Address),
            78 => Instruction::Store(3, PrimitiveType::Address),
            ...
            83 => Instruction::AStore(PrimitiveType::Address),
            ...
            176 => Instruction::Return(PrimitiveType::Address),
